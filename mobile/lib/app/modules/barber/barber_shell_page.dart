...
/// Dashboard/Schedule/Customers/Notifications are placeholders in this
/// slice; only Profile is wired to real data.
        ...
        () => IndexedStack(
          ...
          children: const [
            ComingSoonPage(
              ...
              title: 'Dashboard',
              subtitle:
                  "Today's summary, availability, and next appointment. Coming soon.",
            ),
            ComingSoonPage(
              icon: Icons.calendar_month_outlined,
              title: 'Schedule',
              subtitle: 'Your appointments for today, tomorrow, and the week.',
            ),
            ComingSoonPage(
              icon: Icons.people_outline,
              title: 'Customers',
